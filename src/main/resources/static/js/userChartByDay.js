document.addEventListener('DOMContentLoaded', function () {
    ...
    axios.all([
        axios.get('http://localhost:8080/api/chart/users/login-count/day'),
        axios.get('http://localhost:8080/api/chart/users/register-count/day'),
        axios.get('http://localhost:8080/api/chart/users/unregister-count/day'),
        axios.get('http://localhost:8080/api/chart/users/deactivate-count/day')
    ])
    .then(axios.spread((loginResponse, registerResponse, unregisterResponse, deactivateResponse) => {
        ...
        // Chart.js 구성
        const ctx = document.getElementById('userChartByDay').getContext('2d');
        new Chart(ctx, {
            type: 'line',
            data: {
                labels: labels,
